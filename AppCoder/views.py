...
from AppCoder.forms import AnimalFormulario,PersonaFormulario,UserRegisterForm,VeterinarioFormulario,UserEditForm, AvatarFormulario
from AppCoder.models import Animal, Avatar,Persona,Veterinario, User
#CVB
    ...
    if request.method == 'POST':
        ...
        if miFormulario.is_valid():
            ...
            if informacion['password1'] == informacion['password2']:
                ...
                return render(request, 'AppCoder/inicio.html', {'mensaje':'Contraseña incorrecta'})                                

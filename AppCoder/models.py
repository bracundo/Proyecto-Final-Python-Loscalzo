...
class Animal(models.Model):
    ...
    foto= models.ImageField(default='pug.jpg')    
    def __str__(self):
        return f"Nombre: {self.nombreAnimal} - Edad: {self.edad} - Tipo: {self.tipo} - Motivo: {self.motivo} - Fecha: {self.fecha} - Costo: {self.costo} - Foto: {self.foto}"
